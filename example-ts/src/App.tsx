...
const P1 = React.createContext<{p1: string}>({p1: 'P1'});
const P2 = React.createContext<{p2: string}>({p2: 'P2'});
const P3 = React.createContext<{p3: string}>({p3: 'P3'});
const P4 = React.createContext<{p4: string}>({p4: 'P4'});
